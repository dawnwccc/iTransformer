...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, required=True, default='test', help='models id')
    parser.add_argument('--models', type=str, required=True, default='iTransformer',
                        help='models name, options: [iTransformer, iInformer, iReformer, iFlowformer, iFlashformer]')
